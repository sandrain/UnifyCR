...
int unifyfs_mdhim_init_store(unifyfs_cfg_t* cfg)
{
    int rc, ratio;
...
int unifyfs_mdhim_sanitize(void)
{
    int rc;
    char db_path[UNIFYFS_MAX_FILENAME] = {0};
 ...
 *
 */
int unifyfs_mdhim_set_file_attribute(
    int set_size,
    int set_laminate,
 ...
 *
 */
int unifyfs_mdhim_set_file_attributes(int num_entries,
...
int unifyfs_mdhim_get_file_attribute(
    int gfid,
    unifyfs_file_attr_t* attr)
{
    int rc = UNIFYFS_SUCCESS;
...
int unifyfs_mdhim_delete_file_attribute(
    int gfid)
{
    int rc = UNIFYFS_SUCCESS;
 ...
 *
 */
int unifyfs_mdhim_get_file_extents(int num_keys, unifyfs_key_t** keys,
 ...
 *
 */
int unifyfs_mdhim_set_file_extents(int num_entries,
...
int unifyfs_mdhim_delete_file_extents(
...
struct unifyfs_metaops meta_ops_mdhim = {
    .init                   = unifyfs_mdhim_init_store,
    .finalize               = unifyfs_mdhim_sanitize,
    .get_file_attribute     = unifyfs_mdhim_get_file_attribute,
    .delete_file_attribute  = unifyfs_mdhim_delete_file_attribute,
    .set_file_attribute     = unifyfs_mdhim_set_file_attribute,
    .get_file_extents       = unifyfs_mdhim_get_file_extents,
    .delete_file_extents    = unifyfs_mdhim_delete_file_extents,
    .set_file_extents       = unifyfs_mdhim_set_file_extents,
};

struct unifyfs_metaops* mops = &meta_ops_mdhim;