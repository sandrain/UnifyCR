 ...
 */
int unifyfs_mdhim_get_file_attribute(int gfid,
 ...
 * @return UNIFYFS_SUCCESS on success
 */
int unifyfs_mdhim_delete_file_attribute(int gfid);
 ...
 * @return UNIFYFS_SUCCESS on success
 */
int unifyfs_mdhim_get_file_extents(int num_keys,
 ...
 * @param[in] key_lens array with the length of the elements in \p keys
 */
int unifyfs_mdhim_delete_file_extents(int num_entries,
                                unifyfs_key_t** keys, int* key_lens);
 ...
 * @return UNIFYFS_SUCCESS on success
 */
int unifyfs_mdhim_set_file_extents(int num_entries, unifyfs_key_t** keys,
